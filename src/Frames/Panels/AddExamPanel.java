 ...
 * @author fady_
 */
public class AddExamPanel extends javax.swing.JPanel {
    public AddExamPanel() {
        initComponents();
    }
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(courseId, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE))
    ...
    //this func for radio button to select one button and get his value  
    ...
    /*
        this func to add the exam from a profesor
    */
    private void AddExamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddExamActionPerformed
        if (!AreaQ1.getText().equals("") && !AreaQ2.getText().equals("")
            ...
            Exam e = new Exam();
            e.setEId(Integer.parseInt(courseId.getText()));
    ...
    // this func to reset the data in the jFrame
